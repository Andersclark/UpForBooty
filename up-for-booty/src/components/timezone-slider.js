...
export default class TimezoneSlider extends Component {
  ...
  render() {
    return (
      <div>
        <label>Show people where time is between <i className="font-weight-bold">  {this.state.value[0]}.00  </i> and <i className="font-weight-bold">  {this.state.value[1]}.00  </i></label>
